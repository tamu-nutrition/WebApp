...
class ParticipationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participation" do
    assert_difference('Participation.count') do
      post participations_url, params: { participation: { event_id: @participation.event_id, uin: @participation.uin } }
    end
  ...
  test "should update participation" do
    patch participation_url(@participation), params: { participation: { event_id: @participation.event_id, uin: @participation.uin } }
